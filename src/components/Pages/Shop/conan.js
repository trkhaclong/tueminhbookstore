...
class Conan extends Component {
    ...
    componentDidMount(){
        this.props.getCate2Products(0,'Conan');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate2Products(this.props.site.products.length, 'Conan viết');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
