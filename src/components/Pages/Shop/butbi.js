...
class ButBi extends Component {
    ...
    componentDidMount(){
        this.props.getCate2Products(0,'Bút bi');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate2Products(this.props.site.products.length, 'Bút bi');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
