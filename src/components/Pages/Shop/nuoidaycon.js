...
class NuoiDayCon extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.props.getCate1Products(0,'NUÔI DẠY CON');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate1Products(this.props.site.products.length, 'NUÔI DẠY CON');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
