...
class MauVe extends Component {
    ...
    componentDidMount(){
        this.props.getCate2Products(0,'Màu vẽ');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate2Products(this.props.site.products.length, 'Màu vẽ');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
