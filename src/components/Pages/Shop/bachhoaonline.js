...
class BachHoaOnlineLuuNiem extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.props.getCateProducts(0,'Bách Hóa');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCateProducts(this.props.site.products.length, 'Bách Hóa');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
...
export default withRouter(connect(
    mapStateToProps,
    mapDispatchToProps
)(withStyles(styles)(BachHoaOnlineLuuNiem)));