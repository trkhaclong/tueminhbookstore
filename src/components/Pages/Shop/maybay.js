...
class MayBay extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.props.getCate2Products(0,'Máy bay');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate2Products(this.props.site.products.length, 'Máy bay viết');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
