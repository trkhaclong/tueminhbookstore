...
class TuiVi extends Component {
    ...
    componentDidMount(){
        this.props.getCate2Products(0,'Túi ví');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate2Products(this.props.site.products.length, 'Túi ví viết');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
