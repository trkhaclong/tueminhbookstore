...
class DungCuVe extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.props.getCate1Products(0,'DỤNG CỤ VẼ');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate1Products(this.props.site.products.length, 'DỤNG CỤ VẼ');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
