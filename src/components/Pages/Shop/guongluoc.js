...
class GuongLuoc extends Component {
    constructor(props){
        super(props);
    ...
    componentDidMount(){
        this.props.getCate2Products(0,'Gương lược');
                        ...
                        <div className="text-center">
                            {this.props.site.productCount > this.props.site.products.length ?
                                <div className="tabs-xem-them xem-them-item-aaa">
                                    <Link onClick={e => {
                                        this.props.getCate2Products(this.props.site.products.length, 'Gương lược viết');
                                    }}>Xem Thêm</Link>
                                </div>
                            :null}
                        </div>
