...
function (_React$Component) {
  ...
  function CheckboxGroupField() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (event) {
      ...
      if (multiple) {
        value = (0, _functions.toggle)(_this.filterValue(field.value), event.target.value);
  ...
  _createClass(CheckboxGroupField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_FormControl.default, _extends({
        className: (0, _classnames.default)(_defineProperty({}, classes.rowContainer, row === 'all'), className),
        error: Boolean(message)
      }, props), label && _react.default.createElement(_FormLabel.default, _extends({}, FormLabelProps, {
        className: (0, _classnames.default)(_defineProperty({}, classes.rowLabel, row === 'all'), FormLabelProps && FormLabelProps.className)
        ...
        return _react.default.createElement(_FormControlLabel.default, _extends({
          key: option.value,
          control: _react.default.createElement(_Checkbox.default, _extends({}, CheckboxProps, {
            value: option.value,
      ...
      })), (message || helperText) && _react.default.createElement(_FormHelperText.default, _extends({}, FormHelperTextProps, {
...
if (process.env.NODE_ENV !== 'production') {
  CheckboxGroupField.propTypes = {
    ...
    options: _propTypes.default.arrayOf(_PropTypes.optionShape).isRequired,
    multiple: _propTypes.default.bool,
    row: _propTypes.default.oneOf([true, false, 'all']),
...
var _default = (0, _styles.withStyles)(_rowStyles.default)(CheckboxGroupField);
